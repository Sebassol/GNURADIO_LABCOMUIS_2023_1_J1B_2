...
# Title: ComunicacionesUSRP
# Author: Manuel_Solano_Fabian_Jimenes_J1B_2
# Copyright: Manuel_Solano_Fabian_Jimenes_J1B_2
...
class Lab3_2_1(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "ComunicacionesUSRP", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("ComunicacionesUSRP")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Lab3_2_1")
        ...
        self._GTX_win = RangeWidget(self._GTX_range, self.set_GTX, "Ganancia del GTX", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_TRI_WAVE, 10000, A, 0, 0)
...
def main(top_block_cls=Lab3_2_1, options=None):
