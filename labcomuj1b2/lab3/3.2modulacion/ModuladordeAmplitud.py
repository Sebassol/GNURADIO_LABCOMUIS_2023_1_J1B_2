...
from practica3 import practica3  # grc-generated hier_block



from gnuradio import qtgui

class ModuladordeAmplitud(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "ModuladordeAmplitud")
        ...
        self._ka_range = Range(0, 3, 0.01, 1, 200)
        ...
        self._Ac_win = RangeWidget(self._Ac_range, self.set_Ac, "amplitud de portadora", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self._fm_range = Range(0, samp_rate/4, 100, 1000, 200)
        ...
        self.blocks_wavfile_source_0 = blocks.wavfile_source('/home/labcom/Descargas/y2mate.com-What-Ive-Done.wav', True)
        ...
        self._Am_range = Range(0, 4, 0.1, 1, 200)
        self._Am_win = RangeWidget(self._Am_range, self.set_Am, "amplitud memsaje", "counter_slider", float, QtCore.Qt.Horizontal)
    ...
    def set_ka(self, ka):
        self.ka = ka
        self.Envolvente_compleja_DSB_SC_0.set_K(self.ka)
...
def main(top_block_cls=ModuladordeAmplitud, options=None):
