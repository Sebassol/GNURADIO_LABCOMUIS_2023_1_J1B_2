...
class Lab4_B_ModulacionPM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Lab4_B_ModulacionPM")
        ...
        self._kp_range = Range(0, 40, 0.000001, 1, 200)
        ...
        self._fc_range = Range(50000000, 2000000000, 1000000, 100000000, 200)
        ...
        self.EnvolventeComplejaPM_1 = EnvolventeComplejaPM(
            AC=Ac,
            Kp=kp,
        )
        ...
        # Connections
        ##################################################
        self.connect((self.EnvolventeComplejaPM_1, 0), (self.qtgui_freq_sink_x_0, 0))
        self.connect((self.EnvolventeComplejaPM_1, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.EnvolventeComplejaPM_1, 0), (self.uhd_usrp_sink_0, 0))
        self.connect((self.analog_sig_source_x_0, 0), (self.EnvolventeComplejaPM_1, 0))
    ...
    def set_kp(self, kp):
        self.kp = kp
        self.EnvolventeComplejaPM_1.set_Kp(self.kp)
    ...
    def set_Ac(self, Ac):
        self.Ac = Ac
        self.EnvolventeComplejaPM_1.set_AC(self.Ac)




def main(top_block_cls=Lab4_B_ModulacionPM, options=None):
