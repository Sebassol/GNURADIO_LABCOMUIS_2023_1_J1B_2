...
# Title: MultiplexaPAM
# Author: Manuel_Solano_Y_Fabian_Jimenez
# Copyright: UIS
...
from ModulacionPAM2 import ModulacionPAM2  # grc-generated hier_block
...
class MultiplexaPAM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._D_win = RangeWidget(self._D_range, self.set_D, "ancho de pulso", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.analog_sig_source_x_0_2 = analog.sig_source_f(samp_rate, analog.GR_TRI_WAVE, fm, Am, 0, 0)
        ...
        self.ModulacionPAM2_0_2 = ModulacionPAM2(
            D=10,
            fs=fs,
            samp_rate=samp_rate,
        )
        self.ModulacionPAM2_0_1 = ModulacionPAM2(
            D=10,
            fs=fs,
            samp_rate=samp_rate,
        )
        self.ModulacionPAM2_0_0 = ModulacionPAM2(
            D=10,
            fs=fs,
            samp_rate=samp_rate,
        )
        self.ModulacionPAM2_0 = ModulacionPAM2(
            D=10,
            fs=fs,
            samp_rate=samp_rate,
        )
        ...
        # Connections
        ##################################################
        self.connect((self.ModulacionPAM2_0, 0), (self.blocks_add_xx_0, 0))
        self.connect((self.ModulacionPAM2_0, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.ModulacionPAM2_0_0, 0), (self.blocks_delay_0, 0))
        self.connect((self.ModulacionPAM2_0_1, 0), (self.blocks_delay_0_1, 0))
        self.connect((self.ModulacionPAM2_0_2, 0), (self.blocks_delay_0_0, 0))
        self.connect((self.analog_sig_source_x_0, 0), (self.ModulacionPAM2_0, 0))
        self.connect((self.analog_sig_source_x_0_0, 0), (self.ModulacionPAM2_0_1, 0))
        self.connect((self.analog_sig_source_x_0_1, 0), (self.ModulacionPAM2_0_2, 0))
        self.connect((self.analog_sig_source_x_0_2, 0), (self.ModulacionPAM2_0_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.ModulacionPAM2_0.set_samp_rate(self.samp_rate)
        self.analog_sig_source_x_0.set_sampling_freq(self.samp_rate)
        self.analog_sig_source_x_0_0.set_sampling_freq(self.samp_rate)
        self.analog_sig_source_x_0_1.set_sampling_freq(self.samp_rate)
        self.analog_sig_source_x_0_2.set_sampling_freq(self.samp_rate)
        self.qtgui_time_sink_x_0.set_samp_rate(self.samp_rate)
        self.ModulacionPAM2_0_0.set_samp_rate(self.samp_rate)
        self.ModulacionPAM2_0_1.set_samp_rate(self.samp_rate)
        self.ModulacionPAM2_0_2.set_samp_rate(self.samp_rate)
    ...
    def set_fs(self, fs):
        self.fs = fs
        self.ModulacionPAM2_0.set_fs(self.fs)
        self.ModulacionPAM2_0_0.set_fs(self.fs)
        self.ModulacionPAM2_0_1.set_fs(self.fs)
        self.ModulacionPAM2_0_2.set_fs(self.fs)
