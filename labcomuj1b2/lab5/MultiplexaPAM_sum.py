...
class MultiplexaPAM_sum(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "MultiplexaPAM_sum", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("MultiplexaPAM_sum")
        ...
        self.settings = Qt.QSettings("GNU Radio", "MultiplexaPAM_sum")
        ...
        self.connect((self.ModulacionPAM_0_1, 0), (self.blocks_delay_0_1, 0))
        self.connect((self.ModulacionPAM_0_2, 0), (self.blocks_delay_0_0, 0))
        self.connect((self.ModulacionPAM_1, 0), (self.low_pass_filter_0, 0))
        self.connect((self.ModulacionPAM_1, 0), (self.qtgui_time_sink_x_1, 0))
        self.connect((self.analog_sig_source_x_0, 0), (self.ModulacionPAM_0, 0))
        self.connect((self.analog_sig_source_x_0_0, 0), (self.ModulacionPAM_0_1, 0))
        self.connect((self.analog_sig_source_x_0_1, 0), (self.ModulacionPAM_0_2, 0))
        self.connect((self.analog_sig_source_x_0_2, 0), (self.ModulacionPAM_0_0, 0))
        ...
        self.connect((self.blocks_delay_0_1_0, 0), (self.ModulacionPAM_1, 0))
...
def main(top_block_cls=MultiplexaPAM_sum, options=None):
