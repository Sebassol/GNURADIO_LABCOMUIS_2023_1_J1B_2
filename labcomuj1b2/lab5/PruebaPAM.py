...
class PruebaPAM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Connections
        ##################################################
        self.connect((self.ModulacionPAM_0, 1), (self.qtgui_freq_sink_x_0, 1))
        self.connect((self.ModulacionPAM_0, 0), (self.qtgui_freq_sink_x_0, 0))
        self.connect((self.ModulacionPAM_0, 1), (self.qtgui_time_sink_x_0, 2))
