...
class Lab1_B_2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Lab1_B_2")
        ...
        self._samp_rate_win = RangeWidget(self._samp_rate_range, self.set_samp_rate, "frequencia de muestero", "counter_slider", float, QtCore.Qt.Horizontal)
...
def main(top_block_cls=Lab1_B_2, options=None):
